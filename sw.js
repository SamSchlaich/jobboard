/* 3X Job Board — offline cache. Network-first for the app shell so updates arrive when online; cache fallback when there is no signal. */
const CACHE = "3x-jobboard-v4";
